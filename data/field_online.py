...
def build_transform(is_train, config):
    ...
    # t.append(transforms.Normalize((0.481, 0.458, 0.408), (0.269, 0.261, 0.276)))
    return transforms.Compose(t)

class ImageField_online(RawField):
    def __init__(self, preprocessing=None, postprocessing=None, config=None):
        ...
        super(ImageField_online, self).__init__(preprocessing, postprocessing)
    ...
    def preprocess(self, x, is_train):
        ...
        if is_train:
            ...
            data = self.test_transform(img)
        return (data, image_id)



class ImageDetectionsField_online(RawField):
    def __init__(self, preprocessing=None, postprocessing=None, detections_path=None, max_detections=100,
        ...
        super(ImageDetectionsField_online, self).__init__(preprocessing, postprocessing)
